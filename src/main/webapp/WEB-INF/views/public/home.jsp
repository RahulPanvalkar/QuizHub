		...
		<main>
	        <header>
	            <div class="container text-center my-5">
	                <h1 class="display-5 fw-bold my-2">Welcome</h1>
	                <p class="fs-3">Challenge your mind, conquer the leaderboard — <strong>QuizHub</strong> is your arena!</p>
	                <div class="d-inline-flex gap-2 mb-5">
	                    <a href="./all-quiz.html" class="d-inline-flex align-items-center btn btn-primary btn-lg px-4">
	                        Take a quiz
	                    </a>
	                    <a href="./register.html" class="btn btn-outline-secondary btn-lg px-4" type="button">
	                        Sign Up
	                    </a>
	                </div>
	            </div>
                ...
                <div class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 mx-3">
                    <c:forEach var="i" begin="1" end="3">
                        <article class="col-lg-4 position-relative mb-4">
                            <img src="<c:url value='/images/user.png'/>" class="img-fluid" width="150" height="150" alt="user-profile">
